...
--TODO
CREATE TABLE IF NOT EXISTS DCDeviceDataRaw
  USING JSON
  options (path "/mnt/training/iot-devices/data-centers/energy.json")
...
select 
  ...
  highCO2,
  time
from (select *, FILTER(co2Level, co2 -> co2 > 1400) highCO2 from DCDevices)
...
--TODO
CREATE TABLE IF NOT EXISTS byDevice
using PARQUET
