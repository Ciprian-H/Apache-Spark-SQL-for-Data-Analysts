...
select * from health_tracker_data_2020_02_late tablesample (10 rows)
...
select * from inserts tablesample (10 rows)
...
select * from upserts -- tablesample (10 rows)
...
select * from health_tracker_silver -- tablesample (10 rows)
