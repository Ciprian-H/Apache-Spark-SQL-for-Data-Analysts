...
-- MAGIC
-- MAGIC Notice that it is defined right after the `CREATE TABLE` statement with the name of each column followed by the datatypes within the column. The whole group of columns is surround by parentheses and each individual column is spereated by a comma. 
